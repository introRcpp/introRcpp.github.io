...
qui est une marche symétrique : la formule simplifiée (\ref{rho2}) peut être utilisée.
On doit obtenir quelque chose de similaire à ceci :

```{r fig= TRUE, fig.width = 15, fig.height = 5, echo  = FALSE, fig.align = "center"}
X <- MH(5e4, sd = 0.8)
# var(X)
